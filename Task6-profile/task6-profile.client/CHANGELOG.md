...
- Create Angular project with ng: `ng new task6-profile.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task6-profile.client.esproj`).
