...
- Create Angular project with ng: `ng new task1-12-3-2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task1-12-3-2025.client.esproj`).
